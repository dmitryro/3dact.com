// Compiled with Require.js on Mon Sep 08 2014 17:21:57 GMT-0500 (CDT)

(function(main, modules, paths, Buffer, process, global) {
    ...
    if (nodeModule !== undefined && nodeModule !== null) {
        nodeModule.exports = require(main);
    } else {
    ...
    "./index.js", [
            ...
            function(require, exports, __filename, __dirname, module, process, Buffer, global) {
                ...
                function createRequire(module) {
                    ...
                    function modRequire(path) {
                        return moduleRequire.call(module, path);
                    }

                    function require(path) {
                        return modRequire(require.resolve(path));
                    }
                    require.resolve = function(path) {
                ...
                function resolveNodeModule(path, parent) {
                    ...
                    if (found) {
                        ...
                        if (pkg) resolved = urlPath.join(urlPath.dir(resolved), pkg.main);
            ...
            function(require, exports, __filename, __dirname, module, process, Buffer, global) {
                ...
                var Module = require("../module.js"),
                    ...
                    getAttribute = function(name) {
                        ...
                        return scriptTag.getAttribute(name) || scriptTag.getAttribute("data-" + name) || scriptTag.getAttribute("x-" + name) || "";
                    },
                    hasAttribute = function hasAttribute(name) {

                        return !!(scriptTag.hasAttribute(name) || scriptTag.hasAttribute("data-" + name) || scriptTag.hasAttribute("x-" + name) || "");
                    },
        ...
        function Process() {
            ...
            this.platform = global.navigator ? (global.navigator.platform.split(/[ \s]+/)[0]).toLowerCase() : "unknown";
